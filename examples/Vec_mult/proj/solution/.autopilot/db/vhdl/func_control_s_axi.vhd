...
architecture behave of func_control_s_axi is
    ...
    constant ADDR_Y_DATA_0 : INTEGER := 16#24#;
    constant ADDR_Y_DATA_1 : INTEGER := 16#28#;
    constant ADDR_Y_CTRL   : INTEGER := 16#2c#;
    constant ADDR_Z_DATA_0 : INTEGER := 16#30#;
    constant ADDR_Z_DATA_1 : INTEGER := 16#34#;
    constant ADDR_Z_CTRL   : INTEGER := 16#38#;
