; ModuleID = '/home/giuspru/HLS/tutorial-2023/prova/proj/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_func_ir(i32 %N, %"struct.ap_int<16>"* noalias nocapture nonnull readonly "maxi" %x, %"struct.ap_int<16>"* noalias nocapture nonnull readonly "maxi" %y, %"struct.ap_int<32>"* noalias nocapture nonnull "maxi" %z) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_func_hw(i32 %N, i16* %x_copy, i16* %y_copy, i32* %z_copy)
...
declare void @apatb_func_hw(i32, i16*, i16*, i32*)
...
define void @func_hw_stub_wrapper(i32, i16*, i16*, i32*) #4 {
entry:
  %4 = alloca %"struct.ap_int<16>"
  %5 = alloca %"struct.ap_int<16>"
  %6 = alloca %"struct.ap_int<32>"
  call void @copy_out(%"struct.ap_int<16>"* %4, i16* %1, %"struct.ap_int<16>"* %5, i16* %2, %"struct.ap_int<32>"* %6, i32* %3)
  call void @func_hw_stub(i32 %0, %"struct.ap_int<16>"* %4, %"struct.ap_int<16>"* %5, %"struct.ap_int<32>"* %6)
  call void @copy_in(%"struct.ap_int<16>"* %4, i16* %1, %"struct.ap_int<16>"* %5, i16* %2, %"struct.ap_int<32>"* %6, i32* %3)
  ret void
}

declare void @func_hw_stub(i32, %"struct.ap_int<16>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*)
