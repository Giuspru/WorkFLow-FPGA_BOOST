...
__attribute__((sdx_kernel("func", 0))) void func(unsigned int N, const ap_int<16> *x, const ap_int<16>* y, ap_int<32> *z) ;
# 2 "src/func.cc" 2

__attribute__((sdx_kernel("func", 0))) void func(unsigned int N, const ap_int<16> *x, const ap_int<16>* y, ap_int<32> *z){
#line 18 "/home/giuspru/HLS/tutorial-2023/prova/run_hls.tcl"
...
#pragma hls interface mode=m_axi port=z offset=slave bundle=gmem
 VITIS_LOOP_7_1: for(int i = 0; i < N; i++){
#pragma hls pipeline
 z[i] = x[i] * y[i];
  }
}
